...
namespace Fragsurf.Movement
{
   ...
   public class SurfCharacter : MonoBehaviour, ISurfControllable
   {
      ...
      private void Start()
      {
         ...
         ijump = playerInput.actions["Jump"];
    ...
    //   }
      ...
      private void UpdateMoveData()
      {
         ...
         _moveData.verticalAxis = move.ReadValue<Vector2>().y;
         _moveData.horizontalAxis = move.ReadValue<Vector2>().x;

         _moveData.sprinting = sprint.IsPressed();
