...
public class PlayerAiming : MonoBehaviour
{
	...
	private void Update()
	{
		...
		// Input
		float xMovement = look.ReadValue<Vector2>().x * horizontalSensitivity * sensitivityMultiplier;
		float yMovement = -look.ReadValue<Vector2>().y * verticalSensitivity  * sensitivityMultiplier;
